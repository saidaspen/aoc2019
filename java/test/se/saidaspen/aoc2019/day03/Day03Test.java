package se.saidaspen.aoc2019.day03;
...
public class Day03Test {
    ...
    public void part1() throws IOException {
        assertEquals("1285", new Day03(AocUtil.input(3)).part1());
    }

    @Test
    public void part2() throws IOException {
        assertEquals("14228", new Day03(AocUtil.input(3)).part2());
    }

    @Test
    public void testDistanceToCrossing1() {
        assertEquals("6", new Day03("R8,U5,L5,D3\nU7,R6,D4,L4").part1());
    }

    @Test
    public void testDistanceToCrossing2() {
        assertEquals("159", new Day03(EXAMPLE1).part1());
    }

    @Test
    public void testDistanceToCrossing3() {
        assertEquals("135", new Day03(EXAMPLE_2).part1());
    }

    @Test
    public void givenTestWireLength1() {
        assertEquals("610", new Day03(EXAMPLE1).part2());
    }

    @Test
    public void givenTestWireLength2() {
        assertEquals("410", new Day03(EXAMPLE_2).part2());
    }
}
